...
# BBB sent with wrong tcp checksum
# XXX has correct checksum
...
def segment(dip):
    ...
    # b
    # === wrong checksum ====
    tcp = TCP(ack=myack, dport=dp, sport=sp, flags="PA", window=5480, chksum=0)
    ...
    wrpcap("invalid_checksum_tcp.pcap", packets)
