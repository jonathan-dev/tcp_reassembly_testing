...
def wrapping_add(sum1, sum2):
    return (sum1 + sum2) % 2**32
...
def segment(i):
    ...
    tcp.seq = wrapping_add(tcpseq, p1_seqplus)
    pack1 = ip / tcp / seg1
    ...
    tcp.seq = wrapping_add(tcpseq, p2_seqplus)
    pack2 = ip / tcp / seg2
    packets.append(pack2)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p3_seqplus)
    pack3 = ip / tcp / seg3
    packets.append(pack3)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p3_1_seqplus)
    pack3_1 = ip / tcp / seg3_1
    packets.append(pack3_1)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p3_2_seqplus)
    pack3_2 = ip / tcp / seg3_2
    packets.append(pack3_2)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p3_3_seqplus)
    pack3_3 = ip / tcp / seg3_3
    packets.append(pack3_3)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p3_4_seqplus)
    pack3_4 = ip / tcp / seg3_4
    packets.append(pack3_4)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p3_5_seqplus)
    pack3_5 = ip / tcp / seg3_5
    packets.append(pack3_5)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p3_6_seqplus)
    pack3_6 = ip / tcp / seg3_6
    packets.append(pack3_6)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p4_seqplus)
    pack4 = ip / tcp / seg4
    packets.append(pack4)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p5_seqplus)
    pack5 = ip / tcp / seg5
    packets.append(pack5)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p6_seqplus)
    pack6 = ip / tcp / seg6
    packets.append(pack6)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p7_seqplus)
    pack7 = ip / tcp / seg7
    packets.append(pack7)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p8_seqplus)
    pack8 = ip / tcp / seg8
    packets.append(pack8)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p9_seqplus)
    pack9 = ip / tcp / seg9
    packets.append(pack9)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p10_seqplus)
    pack10 = ip / tcp / seg10
    packets.append(pack10)

    packets.append(ack)

    tcp.seq = wrapping_add(tcpseq, p11_seqplus)
    pack11 = ip / tcp / seg11
    ...
    wrpcap(f"sturges-novak-model-wrap_{i}.pcap", packets)
